...
function findWasmBinary() {
  return locateFile("prehistorie.wasm.wasm");
}
...
var _emInit = Module["_emInit"] = makeInvalidEarlyAccess("_emInit");

var _emUpdate = Module["_emUpdate"] = makeInvalidEarlyAccess("_emUpdate");

var _emResize = Module["_emResize"] = makeInvalidEarlyAccess("_emResize");

var _emGetWidth = Module["_emGetWidth"] = makeInvalidEarlyAccess("_emGetWidth");

var _emGetHeight = Module["_emGetHeight"] = makeInvalidEarlyAccess("_emGetHeight");

var _emGetCell = Module["_emGetCell"] = makeInvalidEarlyAccess("_emGetCell");

var _emGetCellStyle = Module["_emGetCellStyle"] = makeInvalidEarlyAccess("_emGetCellStyle");

var _emHandleKey = Module["_emHandleKey"] = makeInvalidEarlyAccess("_emHandleKey");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["emInit"] != "undefined", "missing Wasm export: emInit");
  _emInit = Module["_emInit"] = createExportWrapper("emInit", 2);
  assert(typeof wasmExports["emUpdate"] != "undefined", "missing Wasm export: emUpdate");
  _emUpdate = Module["_emUpdate"] = createExportWrapper("emUpdate", 1);
  assert(typeof wasmExports["emResize"] != "undefined", "missing Wasm export: emResize");
  _emResize = Module["_emResize"] = createExportWrapper("emResize", 2);
  assert(typeof wasmExports["emGetWidth"] != "undefined", "missing Wasm export: emGetWidth");
  _emGetWidth = Module["_emGetWidth"] = createExportWrapper("emGetWidth", 0);
  assert(typeof wasmExports["emGetHeight"] != "undefined", "missing Wasm export: emGetHeight");
  _emGetHeight = Module["_emGetHeight"] = createExportWrapper("emGetHeight", 0);
  assert(typeof wasmExports["emGetCell"] != "undefined", "missing Wasm export: emGetCell");
  _emGetCell = Module["_emGetCell"] = createExportWrapper("emGetCell", 2);
  assert(typeof wasmExports["emGetCellStyle"] != "undefined", "missing Wasm export: emGetCellStyle");
  _emGetCellStyle = Module["_emGetCellStyle"] = createExportWrapper("emGetCellStyle", 3);
  assert(typeof wasmExports["emHandleKey"] != "undefined", "missing Wasm export: emHandleKey");
  _emHandleKey = Module["_emHandleKey"] = createExportWrapper("emHandleKey", 1);
